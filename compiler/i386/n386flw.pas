...
function ti386raisenode.pass_1 : tnode;
  ...
  begin
    ...
    if (not (target_info.system in systems_i386_seh)) or assigned(left) then
...
procedure ti386onnode.pass_generate_code;
  ...
  begin
    if (not (target_info.system in systems_i386_seh)) then
      begin
...
constructor ti386tryfinallynode.create(l, r: TNode);
  begin
    ...
    if (not (target_info.system in systems_i386_seh)) or
