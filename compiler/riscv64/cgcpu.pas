...
type
  tcg128rv64 = class(tcg128)
    procedure a_op128_reg_reg(list : TAsmList;op:TOpCG;size : tcgsize;regsrc,regdst : tregister128);override;
  end;

procedure tcg128rv64.a_op128_reg_reg(list: TAsmList; op: TOpCG; size: tcgsize; regsrc,regdst: tregister128);
var
  tmp : tregister;
begin
  case op of
    ...
    OP_NEG:
      begin
        ...
        tmp:=cg.getintregister(list,OS_64);
        list.concat(taicpu.op_reg_reg_reg(A_SLTU,tmp,NR_X0,regsrc.reglo));
