...
//     'SOFT',
   ...
   supported_optimizerswitches = genericlevel1optimizerswitches+
				  ...
				  cs_opt_tailrecursion,cs_opt_nodecse,cs_opt_reorder_fields,cs_opt_fastmath,cs_opt_loopmotion,cs_opt_loopunswitch,cs_opt_bitidiom,cs_opt_rangecheckelim,cs_opt_vectorize,cs_opt_jumpthread];
