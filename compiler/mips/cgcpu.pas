...
{$ifdef mips64}
    type
      tcg128mips64 = class(tcg128)
        procedure a_op128_reg_reg(list : TAsmList;op:TOpCG;size : tcgsize;regsrc,regdst : tregister128);override;
      end;

procedure tcg128mips64.a_op128_reg_reg(list: TAsmList; op: TOpCG; size: tcgsize; regsrc,regdst: tregister128);
var
  tmp : tregister;
begin
  case op of
