    ...
    type
       ...
       tcasenode = class(tunarynode)
        ...
        public
          blocks    : TFPList;
          elseblock : tnode;
          // prefer a jump table over a linear compare list; set for the
          // dense dispatch generated by goto label[expr]
          prefer_jumptable : boolean;
...
*****************************************************************************}
    ...
    function tcasenode.dogetcopy : tnode;
      ...
      begin
         ...
         n.prefer_jumptable:=prefer_jumptable;
         dogetcopy:=n;
      end;
